...
- 프로젝트 명 : **DailyKit**
- 프로젝트 유형 : 제품 소개형 랜딩 페이지(1 페이지 인터랙션 사이트)
...
인터랙션 효과로 인한 사용자 경험 향상

**4. 어떤 웹앱을 소개할 것인가?**  
사용자의 능률을 높이기 위한 툴들을 소개할 예정  
...
- 메인 배너, hero 섹션, 툴 소개 섹션, 기능 요소 섹션, 리뷰 섹션

### 4. 인터랙티브 요소

1. 반응형 레이아웃: 데스크톱, 태블릿(브레이크 포인트: 1024px) / 요소 크기 자동 조정
2. hero 섹션: CTA 버튼 클릭 시 smooth scroll
3. 툴 소개 섹션: 카드형 리스트, Swiper, 드래그로 전환, 요소 선택 시 결과창에 그에 해당하는 툴 소개 나열
4. 기능 요소 섹션: 스크롤 시 아이콘, 글씨 순차적 등장(AOS)
5. 리뷰 섹션: Swiper 슬라이드, 네비게이션 버튼
